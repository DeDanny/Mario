...
public class GoombaGardenStart extends Map
{
    public GoombaGardenStart(MarioWorld marioWorld)
    {
        ...
        map.put(12 * 15, new StageChoose[]{StageChoose.GROUNDMIDDLE, StageChoose.CLOUD, StageChoose.TUBE});
        ...
        map.put(12 * 75, new StageChoose[]{StageChoose.GROUNDMIDDLE, StageChoose.TUBE});
